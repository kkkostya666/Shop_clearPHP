...
В текущем проекте уже существует готовый SQL для создания таблицы `lamp`. Создайте
базу данных и импортируйте в неё файл `db/lamp.sql`
...
Добавление в корзину без авторизации (с помощью куки)
Добавление в корзину по сессии
Создание заказа и оплата
Вывод всей истории заказов
